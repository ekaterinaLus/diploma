...
namespace DataStore
{
    ...
    public static class SeedData
    {
        ...
        private static async Task FillUnivers(BusinessUniversityContext context, IEnumerable<Tag> tags, University univ)
        {
        ...
        private static async Task FillProjects(BusinessUniversityContext context, IEnumerable<Tag> tags, IEnumerable<University> univ, IEnumerable<ProjectsCompanies> prj)
        {
            List<Project> items = new List<Project>
            {
                new Project
                {
                    ...
                    Initializer = univ
                                .Where(n => n.Name == "АГУ" && n.ContactInformation == "ЮРИДИЧЕСКИЙ АДРЕС: 414056, Россия, г. Астрахань, ул. Татищева, 20а, Астраханский государственный университет.Телефоны: 8(8512) 24 - 64 - 00.Факс: 8(8512) 49 - 41 - 57.E - mail: asu @asu.edu.ru")
                                    .FirstOrDefault(), 
                     Tags = tags.Where(tag =>
                ...
                new Project
                {
                    ...
                    Stage = ProjectStage.Founding,
                    Initializer = univ
                                .Where(n => n.Name == "АГТУ" && n.ContactInformation == "ЮРИДИЧЕСКИЙ АДРЕС: 414056, Россия, г. Астрахань, ул. Татищева, 20а, Астраханский государственный университет.Телефоны: 8(8512) 24 - 64 - 00.Факс: 8(8512) 49 - 41 - 57.E - mail: asu @asu.edu.ru")
                                    .FirstOrDefault(),
                     Tags = tags.Where(tag =>
                ...
                new Project
                {
                    ...
                    Stage = ProjectStage.Founding,
                    Initializer = univ
                                .Where(n => n.Name == "АГУ" && n.ContactInformation == "г.Астрахань, ул.Татищева, 16. Приемная ректора: тел. (8512) 61-41-19. Общий отдел: тел./факс 61-43-66; e-mail: astu@astu.org")
                                    .FirstOrDefault(),
                     Tags = tags.Where(tag =>
